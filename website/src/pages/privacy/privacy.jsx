    ...
    <section id="privacy">
      ...
      <ul>
        <li>
          ...
          Закону України "Про захист персональних даних" (Відомості Верховної Ради України, 2010 р., № 34, ст. 481; 2014
          р., № 22, ст. 816) и определяет порядок обработки персональных данных и меры по обеспечению безопасности
          персональных данных, предпринимаемые Макаренко Евгений Григорович (далее – Оператор).
        </li>
        <li>
        ...
        <li>
          ...
          всей информации, которую Оператор может получить о посетителях веб-сайта https://wakebooking.space.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          направив Оператору письмо на адрес электронной почты MakarenkoEugeneWB@gmail.com с пометкой «Отказ от
      ...
      <ul>
        ...
        <li>
          ...
          Пользователем самостоятельно через специальные формы, расположенные на сайте https://wakebooking.space.
      ...
      <ul>
        ...
        <li>
          ...
          MakarenkoEugeneWB@gmail.com с пометкой «Актуализация персональных данных».
        </li>
        <li>
          ...
          на электронный адрес Оператора MakarenkoEugeneWB@gmail.com с пометкой «Отзыв согласия на обработку
          персональных данных».
        </li>
      </ul>
      <br />
      ...
      <ul>
        ...
        <li>
          ...
          персональных данных, обратившись к Оператору с помощью электронной почты MakarenkoEugeneWB@gmail.com.
        </li>
        <li>
