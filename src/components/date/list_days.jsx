...
import { changeSelectedDate } from "../../action";
...
function ListDays({ nonWorkingDays, selectedDate, nowDate, calendarDate, changeSelectedDate, setListDateRef }) {
  ...
  return <ul ref={setListDateRef} id="days">{eListDays}</ul>;
}
